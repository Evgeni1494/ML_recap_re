...
ajouter_valeures(titles,genre,country,date)
...
class TopfilmsspiderSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        ajouter_valeures(cleaned_country,cleaned_country,cleaned_country,cleaned_country)
        print(cleaned_country)
        item={}
        item['id']='1'
        item['title']='text'
        item['distributeur']='text'
        item['genre']='text'
        item['dati']='text'
